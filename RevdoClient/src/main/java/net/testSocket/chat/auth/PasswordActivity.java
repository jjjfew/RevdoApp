package net.testSocket.chat.auth;
...
import net.testSocket.chat.ChatActivity;
...
public class PasswordActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignUpButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mEmailSignUpButton.setText("Register and login");
    ...
    void registerEmailUser(){
        ...
        if(!password.equals(password2)) {
            ...
            mPasswordView2.setError("与上面输入密码不同");
        }
        ...
        if (cancel) {
           ...
           //mAuthTask = new UserLoginTask(email, password);
            ...
            Wilddog mWilddogRef = new Wilddog(getResources().getString(R.string.wilddog_url));
            mWilddogRef.createUser(email,password,new MyResultHandler());
        }
    ...
    public class MyResultHandler implements Wilddog.ResultHandler {
        public void onSuccess() {
            ...
            Log.v("XXX","MyResultHandler [success]");
        ...
        public void onError(WilddogError error) {
            if(error != null){
                ...
                if(error.getCode()==-18)
                    Toast.makeText(PasswordActivity.this,"该用户已存在",Toast.LENGTH_SHORT).show();
                else  Toast.makeText(PasswordActivity.this,"注册失败:"+error.getCode()+"",Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(PasswordActivity.this,
